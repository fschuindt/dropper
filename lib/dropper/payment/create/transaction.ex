defmodule Dropper.Payment.Create.Transaction do
  ...
  `Dropper.Payer`.
  """
  @spec create_payer(Dropper.Payment.CreateRequest.t()) ::
  ...
  """
  @spec create_payment(Dropper.Payment.CreateRequest.t(), Ecto.Schema.t()) ::
          {:ok, Ecto.Schema.t()} | {:error, Ecto.Changeset.t()}
  ...
  @spec payer_attributes(Dropper.Payment.CreateRequest.t()) :: %{
          name: String.t(),
          email: String.t()
        }
  ...
  @spec payment_attributes(Dropper.Payment.CreateRequest.t(), Ecto.Schema.t()) :: %{
          payer_id: integer,
          method: integer
        }
